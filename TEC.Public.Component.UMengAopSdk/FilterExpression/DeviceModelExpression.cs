...
namespace TEC.Public.Component.UMengAopSdk.FilterExpression
{
    ...
    /// 筛选字段：设备型号
    /// </summary>
    public class DeviceModelExpression : ExpressionBase
    {

        public DeviceModelExpression(OperationEnum operation, params string[] value)
        {
        ...
        private const string KEY = "device_model";
